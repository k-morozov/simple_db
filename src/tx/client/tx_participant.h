...
class TxParticipant final {
 public:
  ...
  TxParticipant(ActorID client_tx_actor_id, ActorID coordinator_actor_id,
                Retrier* retrier);
  ...
  bool is_open() const noexcept {
    return state_ == TxParticipantState::TX_OPEN;
  }
  Timestamp read_ts() const noexcept {
  ...
  void schedule_requests(Timestamp ts);
